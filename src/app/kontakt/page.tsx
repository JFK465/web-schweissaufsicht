...
const PRODUCT_NAME = "SchweißAufsicht";
const PRODUCT_DOMAIN = "schweissaufsicht-software.de";
const CONTACT_EMAIL = "info@schweissaufsicht-software.de";
          ...
          <div className="rounded-2xl border bg-gradient-to-br from-primary/5 via-background to-primary/10 p-8 sm:p-12">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
                Starten Sie jetzt mit der kostenlosen Beta — unverbindlich und ohne Kreditkarte.
              </p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              <div className="text-center p-4 rounded-xl bg-background/80">
                <svg className="h-6 w-6 text-primary mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                <p className="font-semibold text-sm">Kostenlos testen</p>
                <p className="text-xs text-muted-foreground mt-1">14 Tage unverbindlich</p>
              </div>
              <div className="text-center p-4 rounded-xl bg-background/80">
                <svg className="h-6 w-6 text-primary mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
                <p className="font-semibold text-sm">Keine Kreditkarte</p>
                <p className="text-xs text-muted-foreground mt-1">Einfach registrieren</p>
              </div>
              <div className="text-center p-4 rounded-xl bg-background/80">
                <svg className="h-6 w-6 text-primary mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                <p className="font-semibold text-sm">DSGVO-konform</p>
                <p className="text-xs text-muted-foreground mt-1">Deutsche Server</p>
              </div>
              <div className="text-center p-4 rounded-xl bg-background/80">
                <svg className="h-6 w-6 text-primary mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                <p className="font-semibold text-sm">Sofort startklar</p>
                <p className="text-xs text-muted-foreground mt-1">In 5 Minuten eingerichtet</p>
              </div>
            </div>
            <div className="text-center">
              <Link href="/schweissaufsicht-software" className="inline-flex items-center gap-2 rounded-xl bg-primary px-8 py-3 text-sm font-semibold text-primary-foreground shadow-sm hover:bg-primary/90 transition-colors">
