...
const PROJECT_ID = "schweissaufsicht";
const PROJECT_DOMAIN = "schweissaufsicht-software.de";
const PROJECT_DISPLAY_NAME = "SchweißAufsicht";
const PROJECT_PRIMARY_COLOR = "#2563EB";
const PROJECT_ACCENT_COLOR = "#1E40AF";
const PROJECT_ADMIN_EMAIL = "info@schweissaufsicht-software.de";
const PROJECT_TAGLINE = "Digitaler Arbeitsplatz mit ISO 14731 Aufgabenmatrix (23+ Aufgabenbereiche), Tagesansicht, Mobile-First für Werkstatt, Unterschrift-Workflow, lückenloser Audit-Trail";
