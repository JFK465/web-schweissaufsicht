...
const features = [
  ...
  },
  {
    ...
    description:
      "ISO 9606-1 Prüfbescheinigungen mit automatischen Erinnerungen. 6-Monats-Unterschrift und 3-Jahres-Verlängerung — nie wieder vergessen.",
  },
  {
    icon: FileText,
    title: "WPS- & WPQR-Register",
    description:
      "Vollständiges WPS-Register mit Suchfunktion und Geltungsbereich-Anzeige. Immer die richtige WPS für jede Naht — auch in der Werkstatt.",
  },
  {
    icon: PenLine,
